...
<body class="bg-blue-50 flex overflow-hidden">
            <div class="page-container w-full mx-auto p-8 bg-white rounded-lg shadow-lg border">
                ...
                <div class="flex justify-between items-center my-5">
                    <p class="text-black rounded-md text-center text-xl border border-black p-3">Confirm Selected Allowances</p>
                    <p class="text-black rounded-md text-center text-xl border border-black p-3">Remove Selected Allowances</p>
                </div>
                ...
                <div class="flex justify-center items-center my-5">
                    <p class="text-black rounded-md text-center text-xl border border-black p-3">Select Allowances</p>
                </div>
            </div>
