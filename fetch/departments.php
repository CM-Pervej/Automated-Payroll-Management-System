            ...
            <div class="mx-auto bg-white p-10">
                <section class="flex justify-between mb-5">
                    ...
                    <div class="flex justify-end gap-5">
                        <button id="addDepartmentButton" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 flex items-center">
                            <i class="fas fa-plus mr-2"></i> Add Department
                        </button>
                        <a href="depChange.php" class="btn btn-info">Action</a>
                    </div>
                </section>
