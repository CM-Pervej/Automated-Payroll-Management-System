            ...
            <div class="mx-auto bg-white p-10">
                ...
                <section class="flex justify-between mb-5">
                    ...
                    <div class="flex gap-5">
                        <button id="addAllowanceButton" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700 flex items-center">
                            <i class="fas fa-plus mr-2"></i> Add Allowance
                        </button>
                        <a href="allwChange.php" class="btn btn-info">Action</a>
                    </div>
                </section>
