        ...
        <aside class="fixed left-64 top-0 right-0 bg-blue-50 shadow-md z-10">
            <div class="container mx-auto flex items-center justify-between py-4 px-6">
                ...
                <div class="flex justify-center gap-4">
                    <a href="select/addAllowance.php?employee_id=<?php echo $employee_id; ?>" class="btn btn-primary">Allowance</a>
                    <a href="select/addDeduction.php?employee_id=<?php echo $employee_id; ?>" class="btn btn-secondary">Deduction</a>
                    <a href="select/empCharge.php?employee_id=<?php echo $employee_id; ?>" class="btn btn-accent">Additional Duty</a>
                    <a href="updateProfile.php?employee_id=<?php echo $employee_id; ?>" class="btn btn-outline">Update</a>
                    <form method="POST">
